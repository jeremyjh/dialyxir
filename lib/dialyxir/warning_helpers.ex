defmodule Dialyxir.WarningHelpers do
  ...
  def call_or_apply_to_string(arg_positions, fail_reason, signature_args, signature_return, {overloaded?, contract}) do
    ...
    case fail_reason do
      ...
      :both ->
        pretty_print_signature = Dialyxir.PrettyPrint.pretty_print_contract("#{signature_args} -> #{signature_return}")
        """
