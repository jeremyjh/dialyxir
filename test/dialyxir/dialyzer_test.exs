  ...
  describe "dialyze/3" do
    ...
    test "formatting with no warnings" do
      ...
      { expected_result_code,
        expected_exit_code,
        expected_messages } = dialyze(nil, StubSuccess, nil)

      assert expected_result_code == :ok
      assert expected_exit_code == 0
      assert expected_messages == ["time",
                                   "\e[32mdone (passed successfully)\e[0m"]
    ...
    test "formatting with warnings" do
      ...
      { expected_result_code,
        expected_exit_code,
        expected_messages } = dialyze(nil, StubWarn, nil)
    ...
    test "formatting with errors" do
      ...
      { expected_result_code,
        expected_exit_code,
        expected_messages } = dialyze(nil, StubError, nil)
